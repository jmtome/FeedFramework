...
class LoadResourcePresenterTests: XCTestCase {
    ...
    // MARK: - Helpers
    //We are using strings, but the type is generic, but if it works with one type it will work with any type.
    //We use Strings because they are the easiest to test and debug.
