...
final class RemoteLoaderTests: XCTestCase {
    ...
    //We choose to use String as the generic-specific type because any type that proves the tests would work, and therefore best thing is to use the
    //easiest most common available type such as String or Int
